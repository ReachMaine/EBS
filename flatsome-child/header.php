<!DOCTYPE html>
<?php /* mods
  29Apr16 - brought over mods for new version of flatsome.
     - gtm function code after body tag.
     - two scripts in header for google ads popup
     - add google custome search instead of search
*/ ?>
							...
							<ul id="site-navigation" class="header-nav">
								...
								<li class="search-dropdown">
									...
									<div class="nav-dropdown">
										...
										<?php /* zig - xout replace with gcse above if(function_exists('get_product_search_form')) {
