...
/* mods:
	23Dec2014 - zig - add google ad popup div, just before </body> tag.
	5Jan15 - zig use php to print date for copyright
...
<!-- EBS Popup Sitewide -->
<!-- EBS Popup Sitewide -->
<?php /* <div id="div-gpt-ad-1419369418284-0" style="width:550px; height:480px;">
	<script type="text/javascript">
		googletag.cmd.push(function() { googletag.display('div-gpt-ad-1419369418284-0'); });
	</script>
</div> */ ?>
</body>
</html>